...
const PlanDetailPage = ({ isDarkMode }) => {
    const { planType } = useParams();
    
    // Handle both /order/basic and /order/basic/:planType formats
    const actualPlanType = planType || 'basic';
            ...
            <section className="relative py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className={`text-lg sm:text-xl mb-4 max-w-2xl mx-auto ${
                        ...
                        A clean, well-structured Shopify store built to help you launch confidently and grow.
                    </p>
                    ...
                    <div className={`mt-4 text-center ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                        <div className="flex flex-wrap justify-center gap-4 text-sm">
                            <div className="flex items-center space-x-2">
                                ...
                                <span>Launch-ready in days</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <FaCheck className="w-4 h-4 text-green-600" />
                            ...
                            <div className="flex items-center space-x-2">
                                <FaCheck className="w-4 h-4 text-green-600" />
                                <span>Clean and scalable structure</span>
                            </div>
                        </div>
                    </div>
                </div>
